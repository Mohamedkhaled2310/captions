...
export default function HomePage() {
  return (
      ...
      <div className="flex max-w-7xl mx-auto bg-gray-800">
        ...
        {/* Main Content */}
        <main className="w-3/4 bg-gray-900 rounded-lg">
        ...
        {/* Upload Button */}
        <button className="flex items-center space-x-2 bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
